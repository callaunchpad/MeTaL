"""
Tests NGFFNetwork on an environment
...
flags.DEFINE_float('save_index', 0, 'Saved session file index')
...
def main(argv):
    ...
    with tf.Session() as sess:
        ...
        checkpoint = "./ngff-run-" + str(save_index) + ".ckpt"
